...
public final class EntityUtils {
    ...
    public static String toString(
        ...
        Args.notNull(entity, "Entity");
        final InputStream instream = getInputStream(entity);
        if (instream == null) {
            return null;
        }
        try {
    ...
    private static InputStream getInputStream(final HttpEntity entity) throws IllegalStateException, IOException {
        if (entity.getContent() == null)
            return null;
        final String contentEncoding = entity.getContentEncoding() == null ? "identity" : entity.getContentEncoding().getValue();
        InputStream is = null;
